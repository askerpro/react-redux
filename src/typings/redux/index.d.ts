...
export interface StoreCreator {
  ...
  <S, A extends Action, N>(
    reducer: Reducer<S, A>,
    preloadedState: DeepPartial<S>,
    enhancer?: StoreEnhancer<N>,
  ): Store<S, A, N>;
}
 ...
 *
 */
export type StoreEnhancer<N = never> = (
  next: StoreEnhancerStoreCreator<N>,
) => StoreEnhancerStoreCreator<N>;
export type GenericStoreEnhancer<N = never> = StoreEnhancer<N>;
export type StoreEnhancerStoreCreator<N = never> = <S = any, A extends Action = Action>(
  reducer: Reducer<S, A>,
  preloadedState?: DeepPartial<S>,
) => Store<S, A, N>;
